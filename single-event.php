            ...
            <div class="col-12 col-lg-8">
                <?php if(( function_exists('has_post_thumbnail') ) && ( has_post_thumbnail())): ?>
                    ...
                    <?php if(!empty($post_thumbnail_url)): ?>
                        <img class="img-fluid thumbnail-event" src="<?= $post_thumbnail_url; ?>" alt="<?= the_title(); ?>" />
                    <?php  endif; ?>
                <?php endif; ?>
                ...
                <ul class="nav nav-pills mt-4" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link area active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                            <img src="<?= get_template_directory_uri() . '/assets/images/sobre-o-evento.png' ?>" alt="sobre-o-evento" class="area__icon">
                            <div class="area__title">Sobre o evento</div>
                        </button>
                    </li>

                    <?php $galery = get_field('fotos', $post_id); ?>
                    <?php if(!empty($galery)): ?>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link area" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
                            <img src="<?= get_template_directory_uri() . '/assets/images/fotos.png' ?>" alt="fotos" class="area__icon">
                            <div class="area__title">Fotos</div>
                        </button>
                    </li>
                    <?php endif; ?>

                    <?php $materias = get_field('materias', $post_id); ?>
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link area" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">
                            <img src="<?= get_template_directory_uri() . '/assets/images/material-de-apoio.png' ?>" alt="material-de-apoio" class="area__icon">
                            <div class="area__title">Material de apoio</div>
                        </button>
                    </li>
                    <?php endif; ?>

                    <?php $local = get_field('local', $post_id); ?>
                    <?php if(!empty($local)): ?>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link area" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-map" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">
                            <img src="<?= get_template_directory_uri() . '/assets/images/local.png' ?>" alt="local" class="area__icon">
                ...
                <div class="tab-content mt-4" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                        <div class="galery">
                            <?php foreach($galery as $img): ?>
                                <?= wp_get_attachment_image( $img['ID'], 'full', '', array( 'class' => 'img-fluid' ) ); ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                        <div class="files">
                            ...
                            <a href="<?= $material['url'] ?>" target="_blank" class="file">
